...
/* end of cards */
  ...
  <body>
        ...
        <div class="row mb-5">
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
                ...
                <h3 class=" text-center " style="text-align:center;">View Your Ads</h3>
    ...
    Statement st=con.createStatement();
                         String sql="SELECT * from homeservice.postadd where profemail='"+profemail+"'" ;
                    ...
                    <tr>
                      ...
                      <td><%=rs.getString("profadd")%></%></td>
                        <td><%=rs.getString("servadd")%></%></td>
                      
                        <td><%=rs.getString("description")%></%></td>
                        <td><%=rs.getString("equipments")%></%></td>
                        <td><%=rs.getString("setaprice")%></%></td>
                      
                       <td><a href="delete123.jsp?id=<%=rs.getString("id") %>"><input type="button" value="Delete" onclick="deleteRow(this)"></a></td>
                    </tr>
                    <%
                        }
                     }
  ...
  document.getElementById("myTable").deleteRow(i);
           console.log("going to delete the row from database ...")       
